...
public class MyAdapternews extends RecyclerView.Adapter<MyViewHolderN> {

    private Context context;
    private List<DataClass> dataList;

    public MyAdapternews(Context context, List<DataClass> dataList) {
    ...
    public MyViewHolderN onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_usernews,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolderN holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context,userDetailNews.class);
...
class MyViewHolderN extends RecyclerView.ViewHolder{
