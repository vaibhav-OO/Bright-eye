...
public class DetailRestro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(DetailRestro.this,"Delete",Toast.LENGTH_SHORT).show();
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DetailRestro.this, UpdateRestro.class)
                        ...
                        .putExtra("Timing", detailTiming.getText().toString())
