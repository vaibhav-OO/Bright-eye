...
public class hospital extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager=new GridLayoutManager(hospital.this,1);
        ...
        adapter3=new MyAdapter3(hospital.this,dataList);
        recyclerhospital.setAdapter(adapter3);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), UploadHospital.class));
            }
        });
    }
