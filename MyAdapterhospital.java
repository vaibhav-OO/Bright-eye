...
public class MyAdapterhospital extends RecyclerView.Adapter<MyViewHolderH> {

    private Context context;
    private List<DataClass> dataList;

    public MyAdapterhospital(Context context, List<DataClass> dataList) {
    ...
    public MyViewHolderH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_userchospital,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolderH holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context,userDetailHospital.class);
